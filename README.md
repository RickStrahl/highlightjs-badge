...
* **Fix up lang-csharp Syntax Names**  
Fix up `lang-javascript` style syntax tags generated by various tools like DocFx and properly display the syntax. Same fixup is also applied to `language-css` style syntax.
